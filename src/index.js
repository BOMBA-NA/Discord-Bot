...
app.get('/', (req, res) => {
  res.send('This bot is running BOMBA-NA\'s  <a href="https://github.com/BOMBA-NA/Discord-Bot">Discord-Bot</a>')
})
...
console.log(`\u001b[0m`)
console.log(chalk.red(`© BOMBA-NA | 2022 - ${new Date().getFullYear()}`))
